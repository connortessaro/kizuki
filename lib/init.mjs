...
import { DEFAULT_AGENT_CMD, DEFAULT_TIMEOUT_MS } from "./agent.mjs";

const exists = (p) => access(p).then(() => true, () => false);

const INIT_DIRS = [...REQUIRED_DIRS, "alerts", "days", "state"];
...
export async function runInit(vaultDir, { forceConfig = false } = {}) {
  const created = [];
